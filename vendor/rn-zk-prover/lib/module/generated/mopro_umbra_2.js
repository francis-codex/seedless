...
/* eslint-disable */
// @ts-nocheck
import nativeModule from "./mopro_umbra_2-ffi.js";
...
export function generateCircomProof(zkeyPath, circuitInputs, proofLib) /*throws*/{
  return FfiConverterTypeCircomProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_generate_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterString.lower(circuitInputs), FfiConverterTypeProofLib.lower(proofLib), callStatus);
...
export function generateHalo2Proof(srsPath, pkPath, circuitInputs) /*throws*/{
  return FfiConverterTypeHalo2ProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_generate_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(pkPath), FfiConverterMapStringArrayString.lower(circuitInputs), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateNoirProof(circuitPath, srsPath, inputs, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_generate_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterArrayString.lower(inputs), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function getNoirVerificationKey(circuitPath, srsPath, onChain, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_get_noir_verification_key(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterBool.lower(onChain), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyCircomProof(zkeyPath, proofResult, proofLib) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_verify_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterTypeCircomProofResult.lower(proofResult), FfiConverterTypeProofLib.lower(proofLib), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyHalo2Proof(srsPath, vkPath, proof, publicInput) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_verify_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(vkPath), FfiConverterArrayBuffer.lower(proof), FfiConverterArrayBuffer.lower(publicInput), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyNoirProof(circuitPath, proof, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_mopro_umbra_2_fn_func_verify_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterArrayBuffer.lower(proof), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
/**
...
function uniffiEnsureInitialized() {
  ...
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_generate_circom_proof() !== 55464) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_generate_circom_proof");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_generate_halo2_proof() !== 46845) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_generate_halo2_proof");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_generate_noir_proof() !== 28401) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_generate_noir_proof");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_get_noir_verification_key() !== 30991) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_get_noir_verification_key");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_verify_circom_proof() !== 40361) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_verify_circom_proof");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_verify_halo2_proof() !== 28169) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_verify_halo2_proof");
  }
  if (nativeModule().ubrn_uniffi_mopro_umbra_2_checksum_func_verify_noir_proof() !== 41390) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_umbra_2_checksum_func_verify_noir_proof");
  }
}
...
//# sourceMappingURL=mopro_umbra_2.js.map