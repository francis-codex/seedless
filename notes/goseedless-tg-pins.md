# #GoSeedless — Telegram pinned messages

Two pins, real URLs filled in. Beta pin trimmed for fast scan.

---

## Pin #1 — Beta tester group (tight, paste-ready)
...
Form closes Sat Jun 27, 12:00 WAT.

Beat it up. Be honest.
```

---

## Pin #2 — Main public seedless group (team voice)

Drives traffic to the X post + beta tester group.

```
#GoSeedless is live.

We're paying 25 random testers $5 USDC each to install Seedless v0.4.5-beta and post a real review on X. Top 3 reports get $15 instead.

Open to everyone. Global.

Join the beta tester group here: https://t.me/+CW8dBN7x_tdmN2U0
The pinned message in there has the APK, install guide, tasks, and submission form.

Form closes Saturday Jun 27 at 12:00 WAT. Winners announced Sunday Jun 28.
```
...
| Beta TG invite | https://t.me/+CW8dBN7x_tdmN2U0 |

Gate now public (waitlist function retired, see [[goseedless_campaign_committed_jun22]] for next-cohort gating plan).
